...
export const TRAVELLERDETAILS_SUCCESS = 'TRAVELLERDETAILS_SUCCESS';
export const TRAVELLERDETAILS_FAILURE = 'TRAVELLERDETAILS_FAILURE';

export const SET_PASSENGER_COUNT = 'SET_PASSENGER_COUNT';

export const SET_PINANDSTATE = 'SET_PINANDSTATE';