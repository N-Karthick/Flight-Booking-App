...
const TravellerDetails = () => {
    ...
    const Response = useSelector((state) => state.TravellerDetails.message);
            ...
            <Card sx={{ width: '58rem', height: 'auto', backgroundColor: 'white', position: 'relative', left: '4rem', marginTop: '20px' }}>
                ...
                <div>
                    <div>
                        ...
                        <hr />
                        <div style={{ display: 'flex', justifyContent: 'flex-end', margin: '0.5rem' }}><Button sx={{ border: '2px solid black', backgroundColor: '#f37638', color: 'black', width: '200px' }} 
                ...
                {error && (
                    <div style={{
                        position: 'fixed', top: '20%', left: '20%', width: '60%', height: '60%', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 100, backgroundColor: '#000000a8', transition: 'opacity 0.5s ease', opacity: 1,
                    }}>
                        <Alert
                        ...
                        {Response && (<div>
                            <Alert
                                sx={{ zIndex: 100, display: 'flex', position: 'absolute', left: '80px', bottom: '420px', backgroundColor: 'black' }}
                                severity="success">
                                {Response}
                            </Alert>
                        </div>)}
